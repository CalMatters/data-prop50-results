...
generate-congressional-pmtiles:
    ...
    npx mapshaper inputs/prop50/AB604/AB604.shp --proj wgs84 -o format=geojson inputs/prop50/AB604.json
...
generate-combined-pmtiles:
    tile-join --force -o outputs/precinct_results_plus_demographics_with_congressional.pmtiles outputs/congressional.pmtiles outputs/precinct_results_plus_demographics.pmtiles
    cp outputs/precinct_results_plus_demographics_with_congressional.pmtiles vis/static/precinct_results_plus_demographics_with_congressional.pmtiles